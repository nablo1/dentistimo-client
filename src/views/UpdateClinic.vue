<template>
  <div class="text-center">
      <div>
        ...
        ></b-input>
        <br>
        <b-button type="submit" variant="outline-secondary">Update name</b-button>
        </form>
        <br />
        <h5>Number of Dentists available</h5>
          ...
          ></b-form-spinbutton>
          <br><br>
          <b-button @click="updateDentistsNumber()" variant="outline-secondary">Update number of dentists</b-button>
          <div>      
          <br />
          ...
          ><br />
            ...
            <br>
            <b-button type="submit" variant="outline-secondary">Update opening hours</b-button>
          </form>
          </div>
          </b-card>
      </div>
...
export default {
    ...
    methods: {
        updateName() {
            axios.put('http://localhost:3000/api/dentalClinics/' + this.dentalClinicId, this.newName)
            .then(response => {
        ...
        updateDentistsNumber() {
            axios.put('http://localhost:3000/api/dentalClinics/' + this.dentalClinicId, this.newDentistsNumber)
            .then(response => {
                console.log(response.data)
        ...
        updateOpeningHours() {
            axios.put('http://localhost:3000/api/dentalClinics/' + this.dentalClinicId, this.newOpeningHours)
            .then(response => {
                console.log(response.data)
